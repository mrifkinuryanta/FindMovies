...
class FavoriteTvShowsAdapter :
    PagedListAdapter<TvShowsEntity, FavoriteTvShowsAdapter.FavoriteTvShowsViewHolder>(DIFF_CALLBACK) {
    ...
    inner class FavoriteTvShowsViewHolder(private val binding: ItemsPosterBinding) :
